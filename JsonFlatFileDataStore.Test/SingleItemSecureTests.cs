...
namespace JsonFlatFileDataStore.Test
{
    public class SingleItemSecureTests
    {
        ...
        public void GetItem_DynamicAndTypedSecure()
        {
            ...
            var store = new EncryptedDataStore(path: newFilePath, EncryptionPassword);
        ...
        public void GetItem_DynamicAndTyped_ArrayTypeSecure()
        {
            ...
            var store = new EncryptedDataStore(path: newFilePath, encryptionKey: EncryptionPassword);
        ...
        public void GetItem_DynamicAndTyped_DateTypeSecure()
        {
            ...
            var store = new EncryptedDataStore(newFilePath, EncryptionPassword);
        ...
        public void InsertItem_TypedUserSecure()
        {
            ...
            var store2 = new EncryptedDataStore(newFilePath, EncryptionPassword);
        ...
        public async Task UpdateItem_TypedUserSecure()
        {
            ...
            var store2 = new EncryptedDataStore(path: newFilePath, encryptionKey: EncryptionPassword);
        ...
        public async Task DeleteItem_DynamicUser_NotFoundSecure()
        {
            ...
            var store = new EncryptedDataStore(newFilePath, EncryptionPassword, reloadBeforeGetCollection: true);
